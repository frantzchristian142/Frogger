...
namespace ZeEngine
{
    public class Save
    {
        public int gameId, userId, heroLevel;
        public string gameName, baseFolder, backupFolder, backupPath;
        public float researchPoints, exp;
        ...
        public virtual bool CheckIfFileExists()
        {
            bool fileExists;

            fileExists = File.Exists(Globals.appDataFilePath + "\\"+gameName+"\\XML\\SavedGames\\"+Convert.ToString(gameId, Globals.culture)+".xml") || File.Exists(Globals.appDataFilePath + "\\"+gameName+"\\XML\\SavedGames\\"+Convert.ToString(gameId, Globals.culture));
