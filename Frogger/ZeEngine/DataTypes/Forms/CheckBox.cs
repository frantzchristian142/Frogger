...
namespace ZeEngine
{
    public class CheckBox: FormPart
    {
            ...
            : base(POS, DIMS, TITLE, CHANGED)
        {
            ...
            button = new Button2d("2d\\Misc\\CheckBox", new Vector2(-dims.X/2 + dims.Y/2, 0), new Vector2(dims.Y, dims.Y), new Vector2(1, 2), "Fonts\\Arial16", "", BoxClick, null);
        ...
        public override void LoadData(XElement DATA)
        {
            if(DATA != null)
            {
                ...
                {
                    boxChecked = Convert.ToInt32(DATA.Element("selected").Value, Globals.culture);
                }
            }
        }
        ...
        public override XElement ReturnXML()
        {
            XElement xml = new XElement("Option",
                                ...
                                new XElement("selected", boxChecked));
