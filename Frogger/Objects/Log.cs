...
namespace Frogger
{
    public class Log : Animated2d
    {
        ...
        public Log(string PATH, Vector2 POS, Vector2 DIMS, Vector2 FRAMES, Color COLOR, int DIRECTION, Level LEVEL) : base(PATH, POS, DIMS, FRAMES, COLOR)
        {
            speed = 5.0f;
            direction = DIRECTION;
